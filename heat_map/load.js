...
;(async () => {
  try {
    ...
    d3graph
      ...
      .attr('class', 'footnote')
      .html(
        `*Values rounded to the nearest hundredth. <a target="_blank" href="https://raw.githubusercontent.com/freeCodeCamp/ProjectReferenceData/master/global-temperature.json">Source</a>.`
      )
  } catch (error) {
    alertErr(error)
  }
